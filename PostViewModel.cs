...
// ViewModel для страницы "PostsPage" - главная страница с объявлениями

namespace foodsharing.ViewModels
{
    public class PostViewModel : BaseViewModel
    {
        // Здесь мы объявляем команды
        ...
        // Функция для команды выбора объявления "PostTapped"
